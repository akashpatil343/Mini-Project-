...
quotionEl.innerText=`What is ${n1} divid by ${n2}?`

const ansq = Math.floor(n1/n2);
const ansr =n1%n2;

formEl.addEventListener("submit",()=>{
    atm++
    const userAnsq = +inputEl.value
    const userAnsr = +input2El.value
    
    if((userAnsq==ansq)&&(userAnsr==ansr) ){
        score++;
        cans++;
